...
std::vector<unsigned char> CBCEncrypt(const std::vector<unsigned char>& plaintext, const std::vector<unsigned char>& iv, const std::vector<unsigned char>& key, bool padding = true);
